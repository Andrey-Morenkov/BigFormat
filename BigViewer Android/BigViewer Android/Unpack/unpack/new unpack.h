...
extern "C" UNPACK_API int decode (void * source, void * dest,	short int len);

extern "C" UNPACK_API int decode_x0 (void * source, void * dest,	short int len);
extern "C" UNPACK_API int decode_x1 (void * source, void * dest,	short int len);
extern "C" UNPACK_API int decode_x2 (void * source, void * dest,	short int len);
extern "C" UNPACK_API int decode_x4 (void * source, void * dest,	short int len);
extern "C" UNPACK_API int decode_x8 (void * source, void * dest,	short int len);
